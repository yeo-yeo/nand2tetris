...
class Parser:
    ...
    def command_type(self):
        ...
        # TODO: other types in week 8
        raise Exception('Command not implemented yet', self.current_line)
    ...
    def arg1(self) -> str:
        ...
        if current_command_type == command_type['C_ARITHMETIC']:
            ...
            return parts[1]
        # TODO: other types in week 8
        raise Exception('Command not implemented yet', self.current_line, current_command_type)
    
    def arg2(self) -> str:
        current_command_type = self.command_type()
        parts = self.current_line.split(' ')
        if current_command_type == command_type['C_PUSH'] or current_command_type == command_type['C_POP']:
            return parts[2]
        # TODO: other types in week 8
